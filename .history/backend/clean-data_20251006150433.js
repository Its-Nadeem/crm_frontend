...
export const USERS = [
  ...
  // Org 1 Users
  {
    ...
    teamId: 'team-edtech',
    permissions: [PERMISSIONS.VIEW_ALL_LEADS, PERMISSIONS.ASSIGN_LEADS, PERMISSIONS.MANAGE_USERS, PERMISSIONS.MANAGE_TEAMS, PERMISSIONS.MANAGE_SETTINGS, PERMISSIONS.MANAGE_AUTOMATION, PERMISSIONS.MANAGE_INTEGRATIONS, PERMISSIONS.DELETE_LEADS],
    isTrackingEnabled: true,
  ...
  },
  {
    id: 7,
    name: 'Chris Green',
    email: 'chris@edtech.io',
    password: 'password123',
    avatar: `https://i.pravatar.cc/150?u=7`,
    phone: faker.phone.number(),
    role: USER_ROLES.ADMIN,
    permissions: [PERMISSIONS.MANAGE_USERS, PERMISSIONS.MANAGE_SETTINGS, PERMISSIONS.MANAGE_TEAMS, PERMISSIONS.ASSIGN_LEADS, PERMISSIONS.VIEW_TRACKING_DASHBOARD],
    isTrackingEnabled: true,
    organizationId: 'org-1'
  },
  // Org 2 Users
