...
export const SUBSCRIPTION_PLANS = [
    { _id: faker.string.uuid(), id: 'plan_free', name: 'Free', price: 0, userLimit: 1, features: ['DASHBOARD', 'LEADS', 'TASKS'] },
    { _id: faker.string.uuid(), id: 'plan_basic', name: 'Basic', price: 49, userLimit: 5, features: ['DASHBOARD', 'LEADS', 'TASKS', 'TEAMS', 'SETTINGS', 'INTEGRATIONS', 'WHATSAPP', 'USERS'] },
    { _id: faker.string.uuid(), id: 'plan_pro', name: 'Pro', price: 99, userLimit: 20, features: ['DASHBOARD', 'LEADS', 'TASKS', 'TEAMS', 'SETTINGS', 'INTEGRATIONS', 'WHATSAPP', 'SMS', 'CALLS', 'AUTOMATION', 'REPORTS', 'EMAIL', 'TRACKING', 'USERS'] },
    { _id: faker.string.uuid(), id: 'plan_enterprise', name: 'Enterprise', price: 249, userLimit: 100, features: ['DASHBOARD', 'LEADS', 'TASKS', 'TEAMS', 'SETTINGS', 'INTEGRATIONS', 'WHATSAPP', 'SMS', 'CALLS', 'AUTOMATION', 'REPORTS', 'EMAIL', 'TRACKING', 'API_ACCESS', 'USERS'] },
];
...
// Stages
export const STAGES = [
    { _id: faker.string.uuid(), id: 'new-lead', name: 'New Lead', color: '#3b82f6', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'contacted', name: 'Contacted', color: '#6366f1', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'proposal-sent', name: 'Proposal Sent', color: '#8b5cf6', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'negotiation', name: 'Negotiation', color: '#a855f7', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'closed-won', name: 'Closed-Won', color: '#22c55e', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'closed-lost', name: 'Closed-Lost', color: '#ef4444', organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'new-inquiry', name: 'New Inquiry', color: '#10b981', organizationId: 'org-2' },
    { _id: faker.string.uuid(), id: 'site-visit', name: 'Site Visit Scheduled', color: '#0ea5e9', organizationId: 'org-2' },
    { _id: faker.string.uuid(), id: 'token-received', name: 'Token Received', color: '#f97316', organizationId: 'org-2' },
    { _id: faker.string.uuid(), id: 'sold', name: 'Sold', color: '#16a34a', organizationId: 'org-2' },
    { _id: faker.string.uuid(), id: 'lost', name: 'Lost', color: '#dc2626', organizationId: 'org-2' },
];

// Teams
export const TEAMS = [
    { _id: faker.string.uuid(), id: 'team-edtech', name: 'Ed-Tech Warriors', leadId: 2, memberIds: [3, 4], organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'team-realestate', name: 'Real Estate sharks', leadId: 6, memberIds: [5], organizationId: 'org-2' }
];

// Users
export const USERS = [
  // Super Admin - no org
  { _id: faker.string.uuid(), id: 1, name: 'Nadeem Jabir', email: 'nadeemjabir1@gmail.com', password: 'Nadeem@0331', avatar: `https://i.pravatar.cc/150?u=1`, phone: faker.phone.number(), role: USER_ROLES.SUPER_ADMIN, permissions: [], isTrackingEnabled: true, organizationId: '', superAdminRole: 'Co-Owner' },
  { _id: faker.string.uuid(), id: 8, name: 'Support Admin', email: 'support@super.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=8`, phone: faker.phone.number(), role: USER_ROLES.SUPER_ADMIN, permissions: [], isTrackingEnabled: true, organizationId: '', superAdminRole: 'Support Admin' },
  // Org 1 Users
  { _id: faker.string.uuid(), id: 2, name: 'Samantha Carter (Admin)', email: 'sam@edtech.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=2`, phone: faker.phone.number(), role: USER_ROLES.ADMIN, teamId: 'team-edtech', permissions: [PERMISSIONS.VIEW_ALL_LEADS, PERMISSIONS.ASSIGN_LEADS, PERMISSIONS.MANAGE_USERS, PERMISSIONS.MANAGE_TEAMS, PERMISSIONS.MANAGE_SETTINGS, PERMISSIONS.MANAGE_AUTOMATION, PERMISSIONS.MANAGE_INTEGRATIONS, PERMISSIONS.DELETE_LEADS], isTrackingEnabled: true, organizationId: 'org-1' },
  { _id: faker.string.uuid(), id: 3, name: 'John Doe (Rep)', email: 'john@edtech.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=3`, phone: faker.phone.number(), role: USER_ROLES.SALES_REP, teamId: 'team-edtech', permissions: [], isTrackingEnabled: true, organizationId: 'org-1' },
  { _id: faker.string.uuid(), id: 4, name: 'Jane Smith (Rep)', email: 'jane@edtech.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=4`, phone: faker.phone.number(), role: USER_ROLES.SALES_REP, teamId: 'team-edtech', permissions: [], isTrackingEnabled: false, organizationId: 'org-1' },
  { _id: faker.string.uuid(), id: 7, name: 'Chris Green (Admin)', email: 'chris@edtech.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=7`, phone: faker.phone.number(), role: USER_ROLES.ADMIN, permissions: [PERMISSIONS.MANAGE_USERS, PERMISSIONS.MANAGE_SETTINGS, PERMISSIONS.MANAGE_TEAMS, PERMISSIONS.ASSIGN_LEADS, PERMISSIONS.VIEW_TRACKING_DASHBOARD], isTrackingEnabled: true, organizationId: 'org-1' },
  // Org 2 Users
  { _id: faker.string.uuid(), id: 6, name: 'Jessica Williams (Mgr)', email: 'jessica@realty.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=6`, phone: faker.phone.number(), role: USER_ROLES.MANAGER, teamId: 'team-realestate', permissions: [], isTrackingEnabled: false, organizationId: 'org-2' },
  { _id: faker.string.uuid(), id: 5, name: 'Mike Brown (Rep)', email: 'mike@realty.io', password: 'password123', avatar: `https://i.pravatar.cc/150?u=5`, phone: faker.phone.number(), role: USER_ROLES.SALES_REP, teamId: 'team-realestate', permissions: [], isTrackingEnabled: true, organizationId: 'org-2' },
];

// Custom Field Definitions
export const CUSTOM_FIELD_DEFS = [
    { _id: faker.string.uuid(), id: 'cf_1', name: 'Project Start Date', type: 'date', isRequired: false, organizationId: 'org-1', isMappable: true },
    { _id: faker.string.uuid(), id: 'cf_2', name: 'Primary Need', type: 'text', isRequired: true, organizationId: 'org-1', isMappable: true },
    { _id: faker.string.uuid(), id: 'cf_3', name: 'Company Size', type: 'number', isRequired: false, organizationId: 'org-1', isMappable: false },
    { _id: faker.string.uuid(), id: 'cf_6', name: 'Enquiry Type', type: 'dropdown', options: ['Sales', 'Support', 'General'], isRequired: false, organizationId: 'org-1', isMappable: true },
    { _id: faker.string.uuid(), id: 'cf_4', name: 'Budget', type: 'number', isRequired: true, organizationId: 'org-2', isMappable: true },
    { _id: faker.string.uuid(), id: 'cf_5', name: 'Property Type', type: 'text', isRequired: false, organizationId: 'org-2', isMappable: true },
];
...
export const LEADS = Array.from({ length: 50 }, (_, i) => {
  ...
  // Generate simple activities for the lead
  const activities = [
    {
      type: 'LEAD_CREATED',
...
export const EMAIL_TEMPLATES = [
    { _id: faker.string.uuid(), id: 'et_1', name: 'Welcome Email', subject: 'Welcome to Ed-Tech Global!', body: '<h1>Hi {{name}}!</h1><p>Thanks for joining us. We are excited to have you on board. Here are some resources to get you started.</p>', organizationId: 'org-1', type: 'Email' },
    { _id: faker.string.uuid(), id: 'et_2', name: 'Q2 Promo', subject: 'Don\'t miss our Q2 promotions!', body: '<p>Huge discounts on our most popular courses for a limited time! Check them out now.</p>', organizationId: 'org-1', type: 'Email' },
    { _id: faker.string.uuid(), id: 'et_3', name: 'New Property Alert', subject: 'New Properties in your Area!', body: 'Hi {{name}}, we have new listings that match your criteria. Would you like to schedule a visit?', organizationId: 'org-2', type: 'Email' },
];
...
export const EMAIL_CAMPAIGNS = [
    { _id: faker.string.uuid(), id: 'ec_1', name: 'New User Welcome Series', templateId: 'et_1', status: 'SENT', sentAt: faker.date.recent().toISOString(), scheduledAt: null, recipientCount: 150, openRate: 25.5, organizationId: 'org-1', type: 'Email' },
    { _id: faker.string.uuid(), id: 'ec_2', name: 'Q2 Promotion Blast', templateId: 'et_2', status: 'DRAFT', sentAt: null, scheduledAt: null, recipientCount: 0, openRate: 0, organizationId: 'org-1', type: 'Email' },
    { _id: faker.string.uuid(), id: 'ec_3', name: 'Weekly Property Digest', templateId: 'et_3', status: 'SCHEDULED', sentAt: null, scheduledAt: faker.date.soon({ days: 3 }).toISOString(), recipientCount: 340, openRate: 0, organizationId: 'org-2', type: 'Email' },
];
...
export const LEAD_SCORE_RULES = [
    { _id: faker.string.uuid(), id: 'lsr_1', field: 'source', operator: 'equals', value: 'Website', points: 10, organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'lsr_2', field: 'course', operator: 'contains', value: 'Data Science', points: 20, organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'lsr_3', field: 'email', operator: 'is_not_set', points: -15, organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: 'lsr_4', field: 'customFields.cf_4', operator: 'is_set', points: 15, organizationId: 'org-2' },
];
...
export const WEBHOOKS = [
    { _id: faker.string.uuid(), id: faker.string.uuid(), name: 'Default Webhook', url: `https://api.Clienn CRM.io/v1/webhooks/leads/${faker.string.uuid()}`, isEnabled: true, organizationId: 'org-1' },
    { _id: faker.string.uuid(), id: faker.string.uuid(), name: 'Zapier Integration', url: `https://api.Clienn CRM.io/v1/webhooks/leads/${faker.string.uuid()}`, isEnabled: false, organizationId: 'org-1' },
];

// Support Tickets
export const SUPPORT_TICKETS = [
    { _id: faker.string.uuid(), id: faker.string.uuid(), subject: 'Cannot connect Facebook account', organizationId: 'org-1', userId: 2, status: 'OPEN', createdAt: faker.date.recent({ days: 2 }).toISOString(), lastReplyAt: faker.date.recent({ days: 1 }).toISOString(), replies: [
    ...
    { _id: faker.string.uuid(), id: faker.string.uuid(), subject: 'Billing question for next cycle', organizationId: 'org-2', userId: 6, status: 'IN_PROGRESS', createdAt: faker.date.recent({ days: 3 }).toISOString(), lastReplyAt: faker.date.recent({ days: 1 }).toISOString(), replies: [
        { authorId: 6, message: "I have a question about our upcoming invoice.", timestamp: faker.date.recent({ days: 3 }).toISOString() },
    ]},
    { _id: faker.string.uuid(), id: faker.string.uuid(), subject: 'How to use automation rules?', organizationId: 'org-1', userId: 3, status: 'RESOLVED', createdAt: faker.date.recent({ days: 5 }).toISOString(), lastReplyAt: faker.date.recent({ days: 4 }).toISOString(), replies: [
...
// Addons
export const ADDONS = [
    { _id: faker.string.uuid(), id: 'addon_ai', name: 'AI Power-Up', description: 'Unlock AI lead summaries, predictive analytics, and an AI chatbot.', monthlyPrice: 50, featureTag: 'AI_FEATURES' },
    { _id: faker.string.uuid(), id: 'addon_whatsapp', name: 'WhatsApp Business', description: 'Integrate WhatsApp for direct communication with leads.', monthlyPrice: 25, featureTag: 'WHATSAPP' },
    { _id: faker.string.uuid(), id: 'addon_advanced_analytics', name: 'Advanced Analytics', description: 'Get deeper insights with custom reports and dashboards.', monthlyPrice: 40, featureTag: 'ADVANCED_ANALYTICS' },
    { _id: faker.string.uuid(), id: 'addon_whitelabel', name: 'White-Labeling', description: 'Remove Clienn CRM branding and use your own domain.', monthlyPrice: 150, featureTag: 'WHITE_LABEL' },
];
...
export const COUPONS = [
    { _id: faker.string.uuid(), id: faker.string.uuid(), code: 'SUMMER20', type: 'percentage', value: 20, expiresAt: faker.date.soon({ days: 60 }).toISOString(), isActive: true },
    { _id: faker.string.uuid(), id: faker.string.uuid(), code: 'WELCOME50', type: 'fixed', value: 50, isActive: true },
    { _id: faker.string.uuid(), id: faker.string.uuid(), code: 'EXPIRED', type: 'percentage', value: 10, expiresAt: faker.date.recent({ days: 30 }).toISOString(), isActive: false },
];

// Custom Domains
export const CUSTOM_DOMAINS = [
    { _id: faker.string.uuid(), id: 'cd-1', domain: 'crm.edtechglobal.io', status: 'verified', organizationId: 'org-1' }
];
