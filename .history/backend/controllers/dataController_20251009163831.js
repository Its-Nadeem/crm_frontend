...
const getAppData = async (req, res) => {
    try {
        ...
        let currentSubscriptionPlan = subscriptionPlans.find(plan => plan.id === organization?.subscriptionPlanId);

        if (!currentSubscriptionPlan && organization?.subscriptionPlanId) {
