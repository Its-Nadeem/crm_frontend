...
const updateLead = async (req, res) => {
     try {
         ...
         if (fieldChanges.length > 0) {
             // Check if an identical activity was already created recently
             ...
             const newActivityContent = `${requestUserName} updated - ${changesText}`;
         ...
         if (updateData.hasOwnProperty('customFields')) {
             ...
             if (customFieldChanges.length > 0) {
                 ...
                 newActivities.push({
                     type: 'FIELD_UPDATE',
                     content: `${requestUserName} updated custom fields - ${changesText}`,
                     timestamp: new Date(),
                     authorId: req.user.id // Use the actual user who made the request
                 });
             }
