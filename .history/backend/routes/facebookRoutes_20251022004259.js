    ...
    try {
        ...
        if (existingIntegration && existingIntegration.lastAuthCode === code) {
            ...
            return res.send(`
                ...
                <body>
                    ...
                    <p>Facebook integration already completed. This window will close automatically.</p>
                </body>
                </html>
            `);
        }
        ...
        if (integration) {
            ...
            integration = new FacebookIntegration({
                tenantId,
                fbUserId: pages[0]?.pageId || 'unknown',
                longLivedToken,
        ...
        res.send(`
            ...
            <body>
                ...
                <p>Facebook integration completed successfully! Found ${pages.length} page(s). This window will close automatically.</p>
            </body>
            </html>
        `);
        ...
        res.send(`
            ...
            <body>
                ...
                <p>Error: ${error.message}. This window will close automatically.</p>
            </body>
            </html>
        `);
    }
