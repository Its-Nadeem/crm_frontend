...
import {
    createOrUpdatePaymentGatewaySetting, deletePaymentGatewaySetting, getPaymentGatewaySettings, testPaymentGateway, getEnabledPaymentGateways,
...
router.route('/payment-gateways/provider/:provider').put(createOrUpdatePaymentGatewaySetting);
router.route('/test-payment').post(testPaymentGateway);
