...
const testEndpointsSimple = async () => {
    ...
    try {
        ...
        try {
            const fbWebhookResponse = await fetch('http://localhost:5000/webhook/facebook?hub.mode=subscribe&hub.verify_token=fb_webhook_verify_token_2024_Clienn CRM_secure&hub.challenge=test-challenge');
