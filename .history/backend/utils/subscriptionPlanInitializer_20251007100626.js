...
export const ensureSubscriptionPlans = async () => {
    try {
        ...
        // Ensure org-1 has enterprise plan (always ensure it has enterprise)
        const org1 = await Organization.findOne({ id: 'org-1' });
        if (org1) {
            // Always ensure org-1 has enterprise plan, regardless of current plan
            ...
            console.log('✅ Ensured org-1 has enterprise plan');
        } else {
