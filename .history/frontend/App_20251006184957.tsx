...
const App: React.FC = () => {
    ...
    const [homepageContent, setHomepageContent] = useState<HomepageContent>({
        hero: { title: "", gradientTitle: "", subtitle: "", cta1: "", cta2: "" },
        loginPage: { title: "", subtitle: "", cta: "", image: { src: "", alt: "" } },
        trustedBy: { title: "", logos: [] },
        howItWorks: { title: "", subtitle: "", steps: [] },
        integrations: { title: "", subtitle: "", logos: [] },
        features: { title: "", subtitle: "", items: [] },
        growthChart: { title: "", subtitle: "", chartData: [], stat: { value: 0, label: "" } },
        funnel: { title: "", subtitle: "", stages: [] },
        pricing: { title: "", subtitle: "", monthlyPlans: [], yearlyPlans: [] },
        testimonials: { title: "", items: [] },
        faq: { title: "", subtitle: "", items: [] },
        contactForm: { title: "", subtitle: "", webhookUrl: "", address: "", email: "", phone: "", mapSrc: "", fields: [] },
        chatbot: { enabled: false, welcomeMessage: "", questions: [], thankYouMessage: "", color: "", style: "button" },
        blog: { title: "", subtitle: "" },
        footer: { description: "", address: "", columns: [], socialLinks: [], legal: { copyright: "", links: [] } },
    ...
    const [offerStrip, setOfferStrip] = useState<OfferStrip>({ isEnabled: false, text: "", ctaText: "", ctaLink: "", autoDisableAt: "" });
