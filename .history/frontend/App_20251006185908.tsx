...
import { HOMEPAGE_CONTENT, HOMEPAGE_BLOG_POSTS, HOMEPAGE_PRICING_DATA } from './homepage-content';
            ...
            if (currentUser && authToken) {
                try {
                    ...
                    if (currentUser.role === UserRole.SUPER_ADMIN) {
                        ...
                        setOfferStrip(appData.offerStrip || {isEnabled: false, text: '', ctaText: '', ctaLink: '', autoDisableAt: ''});
