...
const MappingStep: React.FC<{
    ...
    // Define CRM fields (exactly as in your example)
    const crmFields = [
        { id: 'name', label: 'Full Name', required: true },
        { id: 'email', label: 'Email Address', required: true },
        { id: 'phone', label: 'Phone Number', required: false },
        { id: 'city', label: 'City', required: false },
        { id: 'course', label: 'Job Title', required: false }, // Using course as job title
        { id: 'source', label: 'Lead Status', required: false }, // Using source as lead status
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Simple two-column layout exactly as requested */}
            <div className="space-y-4">
                {/* Column headers */}
                <div className="grid grid-cols-2 gap-4 pb-2 border-b border-muted">
                    <div className="font-semibold text-on-surface">CSV Column (from file)</div>
                    <div className="font-semibold text-on-surface">CRM Field (dropdown)</div>
                </div>
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                    {fileData.headers.map(header => {
                        ...
                        return (
                            <div key={header} className="grid grid-cols-2 gap-4 items-center p-3 bg-surface border border-muted rounded-lg">
                                {/* Left: CSV Column info */}
                                <div className="space-y-2">
                                    <div className="font-mono text-sm font-semibold text-on-surface">
                                        {header}
                                    </div>
                                    <div className="text-xs text-subtle bg-muted/50 rounded px-2 py-1">
                                        Sample: {sampleValue}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    {currentMapping && (
                                        <div className="mt-1 text-xs text-green-600 dark:text-green-400">
                                            → {crmFields.find(f => f.id === currentMapping)?.label}
                                        </div>
                                    )}
                                </div>
                            </div>
