                        ...
                        return (
                            <div key={crmField.id} className="grid grid-cols-3 gap-4 items-center py-2">
                                ...
                                <div className="space-y-2">
                                    {crmField.id === 'course' && (
                                        <div className="space-y-1">
                                            <div className="font-medium text-xs">Course Options:</div>
                                            <select
                                    ...
                                    {crmField.id === 'stage' && (
                                        <div className="space-y-1">
                                            <div className="font-medium text-xs">Pipeline Stages:</div>
                                            <select
                                                className="w-full bg-background border border-muted px-2 py-1 rounded text-xs focus:border-primary-500 focus:outline-none"
                                                disabled
                                            >
                                    ...
                                    {crmField.id === 'source' && (
                                        <div className="space-y-1">
                                            <div className="font-medium text-xs">Lead Sources:</div>
                                            <select
                                                className="w-full bg-background border border-muted px-2 py-1 rounded text-xs focus:border-primary-500 focus:outline-none"
                                                disabled
                                            >
                                    ...
                                    {crmField.id.startsWith('customFields.') && (
                                        <div className="space-y-1">
                                            <div className="font-medium text-xs">Custom Field Type:</div>
                                                ...
                                                {(() => {
                                                    ...
                                                    if (customField) {
                                                        switch (customField.type) {
                                                            case 'select':
                                                            case 'multiselect':
                                                                return 'Dropdown selection field - CSV values must match predefined options';
                                                            case 'text':
                                                                return 'Text input field - any text value accepted';
                                                            case 'number':
                                                                return 'Number field - CSV values must be numeric';
                                                            case 'date':
                                                                return 'Date field - CSV values should be in date format';
                                                            case 'boolean':
                                                                return 'Yes/No field - CSV values like "yes", "no", "true", "false"';
                                                            default:
                                                                return 'Custom field - validation depends on field type';
                                                        }
                                                    }
                                                    return 'Custom field - user-defined validation';
                                                })()}
                                            </div>
                                        </div>
                                    )}
