                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="absolute top-full left-0 right-0 bg-background border border-muted rounded-b shadow-lg max-h-32 overflow-y-auto z-10 mt-1">
                                                    <div className="px-2 py-1 text-xs text-muted">New Lead</div>
                                                    <div className="px-2 py-1 text-xs text-muted">Interested</div>
                                                    <div className="px-2 py-1 text-xs text-muted">Qualified</div>
                                                    <div className="px-2 py-1 text-xs text-muted">Proposal Sent</div>
                                                    <div className="px-2 py-1 text-xs text-muted">Negotiation</div>
                                                    <div className="px-2 py-1 text-xs text-muted">Closed Won</div>
                                                    <div className="px-2 py-1 text-xs text-muted">DNP</div>
                                                </div>
                                            </div>
