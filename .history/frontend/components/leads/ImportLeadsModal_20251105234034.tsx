                                ...
                                <div className="space-y-2">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className="w-full bg-background border border-muted px-2 py-1 rounded text-xs focus:border-primary-500 focus:outline-none"
                                                />
                                                <div className="absolute top-full left-0 right-0 bg-background border border-muted rounded-b shadow-lg max-h-32 overflow-y-auto z-10 mt-1 hidden">
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">New Lead</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">Interested</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">Qualified</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">Proposal Sent</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">Negotiation</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">Closed Won</div>
                                                    <div className="px-2 py-1 text-xs hover:bg-muted cursor-pointer">DNP</div>
                                                </div>
                                            </div>
                                    ...
                                    {crmField.id.startsWith('customFields.') && (() => {
                                        ...
                                        if (customField && customField.type === 'dropdown' && customField.options) {
                                            ...
                                            const filteredOptions = searchTerm ? customField.options.filter(option =>
