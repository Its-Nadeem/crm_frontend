            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                ...
                <div className="lg:col-span-2 flex flex-col overflow-hidden bg-background rounded-lg border border-muted">
                    ...
                    <div className="flex-shrink-0 p-2 flex flex-wrap items-center gap-2 border-b border-muted">
                        ...
                        <button onClick={() => {
                            console.log('Add Task button clicked, setting isAddingTask to true');
                    ...
                    <div className="flex-grow overflow-y-auto p-4 space-y-6">
                        ...
                        {activeTab === 'tasks' && (
                            <div className="space-y-2">
                                {isAddingTask && <AddTaskForm lead={editableLead} onAddTask={onAddTask} onCancel={() => setIsAddingTask(false)} currentUser={currentUser} onTaskCreated={loadNotesAndCalls} />}
                                {leadTasks.map(task => (
