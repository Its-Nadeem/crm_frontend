   ...
   const handleAddNote = async (noteContent: string) => {
    ...
    return (
        <Modal isOpen={true} onClose={handleClose} title="">
            {isWhatsAppModalOpen && <WhatsAppModal lead={editableLead} templates={whatsAppTemplates} currentUser={currentUser} onClose={() => setWhatsAppModalOpen(false)} onSend={handleSendWhatsApp} addToast={(toast) => console.log('Toast:', toast)} />}
                            ...
                            <div className="space-y-2">
                                {isAddingTask && (
                                    <>
                                        ...
                                        }} currentUser={currentUser} onTaskCreated={loadNotesAndCalls} addToast={(toast) => console.log('Toast:', toast)} />
                                    </>
                                )}
                                {leadTasks.map(task => (
