    ...
    const handleFieldChange = (field: keyof Lead, value: any) => {
        ...
        if (oldValue !== newValue) {
            ...
            if (field === 'assignedToId') {
                ...
                // For dropdown changes (assignedToId, stage), create activity immediately
                ...
                // For stage changes, create activity immediately
                const fieldUpdateActivity: Activity = {
                    id: `field-update-${field}-${Date.now()}`,
                    type: 'FIELD_UPDATE',
                    content: changeDescription,
                ...
                // For input fields (text, number like dealValue), don't create activities until save
