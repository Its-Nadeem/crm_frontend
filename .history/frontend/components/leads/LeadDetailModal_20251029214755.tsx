    ...
    return (
        <Modal isOpen={true} onClose={() => {}} title="">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
                {/* Left Column: Details */}
                <div className="lg:col-span-1 overflow-y-auto pr-4" style={{ overscrollBehavior: 'contain' }}>
                ...
                <div className="lg:col-span-2 flex flex-col overflow-hidden bg-background rounded-lg border border-muted" style={{ overscrollBehavior: 'contain' }}>
