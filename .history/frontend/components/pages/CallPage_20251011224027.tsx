...
interface CallPageProps {
    ...
    onSaveScript: (script: CallScript) => void;
    onDeleteScript: (scriptId: string) => void;
    onSaveCampaign: (campaign: CallCampaign) => void;
...
const CallPage: React.FC<CallPageProps> = ({ scripts, campaigns, onSaveScript, onDeleteScript, onSaveCampaign, onDeleteCampaign, users, pipelineStages, customFieldDefs }) => {
