...
const Dashboard: React.FC<DashboardProps> = ({ leads, users, pipelineStages, customWidgets, onSaveWidget, onDeleteWidget }) => {
    ...
    // Fetch system information - only for super admin users
    useEffect(() => {
        const fetchSystemInfo = async () => {
            try {
                ...
                // Silently fail for non-super admin users
                console.log('System monitoring not available for this user role');
            }
        };
