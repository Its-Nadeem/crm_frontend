...
const EmailPage: React.FC<EmailPageProps> = ({ users, pipelineStages, customFieldDefs }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            {modal === 'campaign' && <CampaignFormModal campaign={editingItem as Partial<EmailCampaign>} templates={templates} onClose={closeModal} onSave={handleSaveCampaign} users={users} pipelineStages={pipelineStages} customFieldDefs={customFieldDefs} />}
