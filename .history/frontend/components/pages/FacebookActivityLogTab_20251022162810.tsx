                                        ...
                                        <div className="flex-1">
                                            ...
                                            {condition.value === 'custom' && (
                                                <div className="mt-2 space-y-2">
                                                    <div>
                                                        <label htmlFor="startDate" className="block text-xs font-medium text-on-surface mb-1">
                                                            Start Date
                                                        </label>
                                                        <input
                                                            id="startDate"
                                                    ...
                                                    <div>
                                                        <label htmlFor="endDate" className="block text-xs font-medium text-on-surface mb-1">
                                                            End Date
                                                        </label>
                                                        <input
                                                            id="endDate"
