                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-background rounded-lg border border-muted p-6 shadow-sm">
                                ...
                                <div className="space-y-4 ml-11">
                                    {/* Real Facebook Pages */}
                                    {accounts.find(acc => acc.id === 'fb-main')?.pages.map((page: any) => (
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <label className="relative inline-flex items-center cursor-pointer">
                                                    <input
                                                        ...
                                                        onChange={(e) => handleSubscriptionToggle('fb-main', page.id, e.target.checked)}
                                                        disabled={loading}
                                    ...
                                    {accounts.find(acc => acc.id === 'fb-main')?.pages.length === 0 && (
