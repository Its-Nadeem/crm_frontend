...
export const FacebookIntegrationPage: React.FC<FacebookIntegrationPageProps> = ({
    ...
    useEffect(() => {
        ...
        console.log('Loading Facebook data, current setting:', currentSetting);
    ...
    }, [currentSetting?.isConnected, dataLoaded]);
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                                ...
                                <p className="text-yellow-700 text-sm">Accounts state: {JSON.stringify(accounts)}</p>
                                <p className="text-yellow-700 text-sm">Current setting: {JSON.stringify(currentSetting)}</p>
                                <p className="text-yellow-700 text-sm">Loading: {loading ? 'true' : 'false'}</p>
                            ...
                            <div className="bg-background rounded-lg border border-muted p-6 shadow-sm">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h4 className="font-semibold text-on-surface">{accounts.find(acc => acc.id === 'fb-main')?.name || 'Connected Facebook Account'}</h4>
                                    </div>
                                </div>

                                <div className="space-y-4 ml-11">
                                    {/* Real Facebook Pages */}
                                    {accounts.length > 0 && accounts.find(acc => acc.id === 'fb-main')?.pages && accounts.find(acc => acc.id === 'fb-main')?.pages.length > 0 ? (
                                        ...
                                        <div className="text-center py-4 text-subtle">
                                            ...
                                            <p className="text-xs mt-2">Make sure your Facebook integration is properly connected in the backend.</p>
                                        </div>
                                    )}
                                </div>
                            </div>

                            {/* Show message when no additional accounts */}
                            {accounts.length <= 1 && (
                                <div className="text-center py-8 text-subtle bg-muted/20 rounded-lg">
                                    ...
                                    <p>No additional Facebook accounts connected.</p>
                                    <p className="text-sm mt-1">Use the "Add Account" button above to connect more accounts.</p>
                                </div>
                            )}
                        </div>
                    </div>
