...
export const FacebookIntegrationPage: React.FC<FacebookIntegrationPageProps> = ({
    ...
    // CRM fields for mapping - fetched from API
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.success) {
                    ...
                    console.log('Fetched CRM fields:', data.fields);
                }
            }
        } catch (error) {
                    ...
                    <div className="bg-background rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col ring-1 ring-inset ring-muted/50">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-blue-50 rounded-lg p-4 mb-4">
                                            <p className="text-sm text-blue-800">
                                                <strong>Form Selected:</strong> {forms.find(f => f.formId === mappingForm.formId)?.formName}
                                            </p>
                                            <p className="text-sm text-blue-800 mt-1">
                                                <strong>Available Fields:</strong> {facebookFields.length} fields from your Facebook form
                                            </p>
                                        </div>
                        ...
                        <div className="flex justify-end gap-3 p-6 border-t border-muted bg-muted/30">
                            ...
                            >
                                ...
                                {!isMappingValid && unmappedMandatoryFields.length > 0 && (
                                    <span className="ml-2 text-xs">
                                        (Map {unmappedMandatoryFields.length} required fields)
                                    </span>
                                )}
                            </button>
                        </div>
