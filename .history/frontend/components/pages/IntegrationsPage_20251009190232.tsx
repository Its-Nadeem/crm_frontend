...
const WebhookManager: React.FC<{
...
}> = ({ webhooks, onAddWebhook, onDeleteWebhook, onToggleWebhook, onTestWebhook, onViewLogs }) => {
    ...
    const [newWebhook, setNewWebhook] = useState({
        name: '',
        url: '',
        events: ['lead.created', 'lead.updated'] as WebhookConfig['events'],
        isEnabled: true
    });
    ...
    return (
        <>
            ...
            {deleteModal.isOpen && deleteModal.webhook && (
                <Modal isOpen={true} onClose={handleDeleteCancel} title="Delete webhook">
                    <div className="space-y-4">
                        ...
                        <div className="bg-background p-4 rounded-lg border border-muted space-y-3">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-1 mt-1">
                                    {deleteModal.webhook.events.map(event => (
