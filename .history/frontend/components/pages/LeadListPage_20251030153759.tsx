...
const LeadListPage: React.FC<{
    ...
    const [columnOrder, setColumnOrder] = useState<string[]>([
        'checkbox', 'name', 'source', 'email', 'phone', 'alternatePhone',
        'city', 'course', 'company', 'stage', 'followUpStatus', 'score',
        'tags', 'assignedToId', 'dealValue', 'closeDate', 'campaign',
        'facebookCampaign', 'facebookAdset', 'facebookAd', 'createdAt', 'updatedAt', 'actions'
    ]);
    const [visibleColumns, setVisibleColumns] = useState({
        name: true, email: true, phone: true, alternatePhone: false, city: false,
        course: false, company: false, source: false, stage: true, followUpStatus: false,
        score: false, tags: false, assignedToId: true, dealValue: false,
        closeDate: false, campaign: false, facebookCampaign: false,
