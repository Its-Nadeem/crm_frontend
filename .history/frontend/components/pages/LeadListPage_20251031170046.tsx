...
const LeadListPage: React.FC<{
    ...
    useEffect(() => {
        const savedColumnOrder = localStorage.getItem('leadColumnOrder');
        const savedVisibleColumns = localStorage.getItem('leadVisibleColumns');
        ...
        if (savedVisibleColumns) {
            try {
                ...
                setVisibleColumns(prev => ({ ...prev, ...parsedVisible }));
            } catch (error) {
                console.error('Failed to parse saved visible columns:', error);
            }
        }
    }, []);
    ...
    useEffect(() => {
        localStorage.setItem('leadVisibleColumns', JSON.stringify(visibleColumns));
    }, [visibleColumns]);
                        ...
                        <div className="flex justify-end gap-3 pt-4 border-t border-muted">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    localStorage.setItem('leadColumnPreferences', JSON.stringify(columnPreferences));
