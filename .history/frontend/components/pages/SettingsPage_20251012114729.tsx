                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <button
                                            ...
                                            disabled={isLoading !== null}
                                            className="p-2 text-subtle hover:text-on-surface hover:bg-muted rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                                            title="Edit rule"
                                        >
                                        ...
                                        <button
                                            ...
                                            disabled={isLoading !== null}
                                            className="p-2 text-subtle hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                                            title="Delete rule"
                                        >
                                            <AppIcons.Delete className="w-4 h-4" />
                                        </button>
