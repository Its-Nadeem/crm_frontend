...
const MonitoringTab: React.FC<{
    ...
    const serviceStatus = monitoringData?.serviceStatus || { API: 'Operational', Database: 'Operational', 'Facebook Sync': 'Degraded' };
    const realHealthData = monitoringData?.healthData || healthData;
