        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div className="bg-surface p-4 rounded-xl shadow-lg border border-muted/50"><h3 className="text-sm font-semibold text-subtle text-center">CPU Load (%)</h3><ResponsiveContainer width="100%" height={100}><AreaChart data={realHealthData} margin={{top:10, right:0, left:0, bottom:0}}><Tooltip/><Area type="monotone" dataKey="cpuLoad" stroke="#8884d8" fill="#8884d8" /></AreaChart></ResponsiveContainer></div>
                    <div className="bg-surface p-4 rounded-xl shadow-lg border border-muted/50"><h3 className="text-sm font-semibold text-subtle text-center">Memory (%)</h3><ResponsiveContainer width="100%" height={100}><AreaChart data={realHealthData} margin={{top:10, right:0, left:0, bottom:0}}><Tooltip/><Area type="monotone" dataKey="memoryUsage" stroke="#82ca9d" fill="#82ca9d" /></AreaChart></ResponsiveContainer></div>
                    <div className="bg-surface p-4 rounded-xl shadow-lg border border-muted/50"><h3 className="text-sm font-semibold text-subtle text-center">Response (ms)</h3><ResponsiveContainer width="100%" height={100}><AreaChart data={realHealthData} margin={{top:10, right:0, left:0, bottom:0}}><Tooltip/><Area type="monotone" dataKey="responseTime" stroke="#ffc658" fill="#ffc658" /></AreaChart></ResponsiveContainer></div>
                </div>
                 <div className="bg-surface p-6 rounded-xl shadow-lg border border-muted/50">
