...
const UserManagementPage: React.FC<UserManagementPageProps> = ({ users, teams, onSaveUser, onDeleteUser }) => {
    ...
    console.log('📊 UserManagementPage: Received users count:', users.length);
    console.log('👥 UserManagementPage: Users:', users.map(u => ({ id: u.id, name: u.name, email: u.email })));
    ...
    const handleDeleteUser = async (userId: number) => {
        ...
        console.log('🗑️ UserManagementPage: Starting optimistic deletion for userId:', userId);
        console.log('📊 UserManagementPage: Current users count before deletion:', users.length);
