...
const UserManagementPage: React.FC<UserManagementPageProps> = ({ users, teams, onSaveUser, onDeleteUser }) => {
    ...
    const handleDeleteUser = async (userId: number) => {
        ...
        console.log('📊 UserManagementPage: Current local users count:', localUsers.length);
        ...
        setLocalUsers(prev => {
            ...
            console.log('⚡ UserManagementPage: Optimistically removed user. Before:', prev.length, 'After:', filtered.length);
            return filtered;
        });
