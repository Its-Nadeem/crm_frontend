...
const UserManagementPage: React.FC<UserManagementPageProps> = ({ users, teams, onSaveUser, onDeleteUser }) => {
    ...
    // Get current organization ID from localStorage or props
    const currentOrgId = localStorage.getItem('currentOrganizationId') || 'org-1'; // fallback to org-1

    // Set up real-time sync for user updates
