...
const WebhookLogsModal: React.FC<WebhookLogsModalProps> = ({
    ...
    const fetchLogs = async () => {
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/webhooks/${webhookId}/logs?${queryParams}`, {
                headers: {
                ...
                <div className={`${selectedLog ? 'w-2/3' : 'w-full'} flex flex-col`}>
                    ...
                    <div className="flex-1 overflow-hidden">
                        {loading ? (
                            ...
                            <div className="p-8 text-center">
                                <AppIcons.Clock className="h-12 w-12 text-muted mx-auto mb-4" />
