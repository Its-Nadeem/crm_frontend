    ...
    useEffect(() => {
        if (currentUser && currentUser.role !== UserRole.SUPER_ADMIN) {
            const loadOrganizations = async () => {
                try {
                    // For regular users, we need to get their organization data
                    // This should include the latest subscription information
                    console.log('Loading organization data for user:', currentUser.id);
                    // The organizations array should be populated from the main data loading
                } catch (error) {
