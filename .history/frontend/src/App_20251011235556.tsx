...
const App: React.FC = () => {
    ...
    const userStages = useMemo(() => {
        ...
        console.log('userStages computed:', {
    ...
    const onDeleteStage = useCallback(async (id: string) => {
        ...
        try {
            ...
            setStages(prev => {
                ...
                console.log('Stage deleted successfully. Stages before:', prev.length, 'Stages after:', updatedStages.length);
                console.log('Deleted stage ID:', id);
                console.log('Remaining stages:', updatedStages.map(s => ({id: s.id, name: s.name})));
        ...
        <Routes>
            ...
            <Route path="/marketing" element={<MarketingLayout />}>
                 ...
                 <Route path="sms" element={<SMSPage
                     ...
                     onSaveTemplate={(template) => createOrUpdateItem('/api/marketing/templates/sms', template, setSmsTemplates)}
                     onDeleteTemplate={(id) => deleteItem('/api/marketing/templates/sms', id, setSmsTemplates)}
                     onSaveCampaign={(campaign) => createOrUpdateItem('/api/marketing/campaigns/sms', campaign, setSmsCampaigns)}
                     onDeleteCampaign={(id) => deleteItem('/api/marketing/campaigns/sms', id, setSmsCampaigns)}
                 />} />
