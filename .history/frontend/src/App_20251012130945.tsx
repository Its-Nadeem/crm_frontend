    ...
    const mainContent = (
        <Routes>
            ...
            <Route path="/settings" element={<SettingsLayout />}>
                ...
                <Route path="users" element={<UserManagementPage users={userUsers} teams={userTeams} onSaveUser={onSaveUser} onDeleteUser={(id) => deleteItem('/api/settings/users', id.toString(), setUsers)} />} />
