    ...
    const handleDeleteUser = useCallback(async (userId: number) => {
        try {
            ...
            setUsers(prev => {
                ...
                console.log(`User ${userId} deleted. Users before: ${prev.length}, after: ${updated.length}`);
                return updated;
            });
    ...
    const mainContent = (
        <Routes>
            ...
            <Route path="/settings" element={<SettingsLayout />}>
                ...
                <Route path="users" element={<UserManagementPage users={userUsers} teams={userTeams} onSaveUser={onSaveUser} onDeleteUser={(id) => { const deleteUserById = async (userId: string) => { await apiService.requestWithRetry(`/settings/users/${userId}`, { method: 'DELETE' }); setUsers(prev => prev.filter(u => u.id !== parseInt(userId))); }; return deleteUserById(id.toString()); }} />} />
