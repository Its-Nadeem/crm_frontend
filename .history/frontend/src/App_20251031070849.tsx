    ...
    const mainContent = (
        <Routes>
            ...
            <Route path="/settings" element={<SettingsLayout />}>
                ...
                <Route path="users" element={<UserManagementPage key={`users-${userUsers.length}-${users.length}`} users={userUsers} teams={userTeams} onSaveUser={onSaveUser} onDeleteUser={handleDeleteUser} />} />
