...
const App: React.FC = () => {
    ...
    const handleDeleteUser = useCallback(async (userId: number) => {
        try {
            ...
            // Force a re-render by updating the key prop to trigger component remount
            // This ensures the table reflects the updated user list immediately
            setTimeout(() => {
                console.log('🔄 App.tsx: Forcing component re-render');
    ...
    const mainContent = (
        <Routes>
            ...
            <Route path="/settings" element={<SettingsLayout />}>
                ...
                <Route path="users" element={<UserManagementPage key={`users-${userUsers.length}-${Date.now()}`} users={userUsers} teams={userTeams} onSaveUser={onSaveUser} onDeleteUser={handleDeleteUser} />} />
