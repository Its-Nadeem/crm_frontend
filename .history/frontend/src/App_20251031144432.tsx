    ...
    const mainContent = (
        <Routes>
            ...
            <Route path="/settings" element={<SettingsLayout />}>
                ...
                <Route path="users" element={<UserManagementPage key={`users-${userUsers.length}-${JSON.stringify(userUsers.map(u => u.id))}`} users={userUsers} teams={userTeams} onSaveUser={onSaveUser} onDeleteUser={handleDeleteUser} />} />
