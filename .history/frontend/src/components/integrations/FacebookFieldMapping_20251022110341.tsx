                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                        {getSortedFacebookFields().map(field => {
                            ...
                            return (
                                <div key={field.name} className="bg-background rounded-lg border border-muted p-3 shadow-sm">
                                    <select
                                    ...
                                    {/* Show custom value input when NO CRM field is selected (for fixed values) */}
                                    {!currentMapping?.crmField && (
                                        <div className="mt-2">
                                            <input
                                                type="text"
                                            ...
                                            <div className="text-xs text-subtle mt-1">
                                                Leave empty to skip this field, or enter a fixed value
                                            </div>
                                        </div>
                                    )}

                                    {/* Show custom value input when CRM field IS selected (optional override) */}
                                    {currentMapping?.crmField && currentMapping.crmField === 'stage' && (
                                        <div className="mt-2">
                                            <select
                                                ...
                                                className="w-full px-3 py-2 border border-muted rounded-lg bg-background text-on-surface focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                            >
                                                <option value="">Select Sales Pipeline Stage (optional)</option>
                                    ...
                                    {currentMapping?.crmField && currentMapping.crmField !== 'stage' && (
                                        <div className="mt-2">
                                            ...
                                            />
                                            <div className="text-xs text-subtle mt-1">
                                                Optional: Override the mapped value with a fixed value
                                            </div>
                                        </div>
                                    )}
                                </div>
