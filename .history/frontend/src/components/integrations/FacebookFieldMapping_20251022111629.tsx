                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                        {getSortedFacebookFields().map(field => {
                            ...
                            return (
                                <div key={field.name} className={`rounded-lg border p-3 shadow-sm transition-colors min-h-[60px] flex items-center ${
                                    isMapped ? 'bg-blue-50 border-blue-200' : 'bg-background border-muted'
                                }`}>
                                    <div className="flex items-center justify-between w-full">
                                        <div className="flex items-center gap-2">
                                            {/* Status dot indicator */}
                                            <div className={`w-2 h-2 rounded-full ${isMapped ? 'bg-green-500' : 'bg-red-500'}`}></div>
