...
export const ActivityTimeline: React.FC<ActivityTimelineProps> = ({
    ...
    // Real-time updates (polling fallback every 10 seconds)
    useEffect(() => {
        if (!isRealTimeEnabled || !onRefresh || isConnected) return;
    ...
    const getStatusBadge = (status?: string) => {
        ...
        const statusConfig = {
            sent: { label: 'Sent', className: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300' },
