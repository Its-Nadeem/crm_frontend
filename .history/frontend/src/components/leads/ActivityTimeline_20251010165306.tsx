...
export const ActivityTimeline: React.FC<ActivityTimelineProps> = ({
    ...
    useEffect(() => {
        // Don't poll if realTime is disabled, component polling is disabled, no refresh function, or WebSocket is connected
        if (!realTime || !isRealTimeEnabled || !onRefresh || isConnected) {
    ...
    }, [realTime, isRealTimeEnabled, onRefresh, isConnected]);
    ...
    // Cleanup effect to ensure polling is stopped when component unmounts or realTime becomes false
    useEffect(() => {
        return () => {
