...
// FIX: Rewrote object creation to help TypeScript compiler and avoid iterator error.
   ...
   const handleEmailSent = (emailData: any) => {
    ...
    const showPageSkeleton = !lead && isLoadingLead && !isMutatingRef.current && !disableTimelineAutoRefresh;       // only first time, no data yet, not mutating, not after note save
