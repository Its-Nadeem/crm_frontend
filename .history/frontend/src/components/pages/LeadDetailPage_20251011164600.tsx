   ...
   const handleEmailSent = (emailData: any) => {
    ...
    const handleAddNote = async (noteData: { content: string; leadId: string }) => {
        try {
            ...
            // Use batched request system to refresh both activities and lead data
            addToRequestBatch('activities');
            addToRequestBatch('lead');

            // Also refresh from props leads array immediately to ensure lead data is available
