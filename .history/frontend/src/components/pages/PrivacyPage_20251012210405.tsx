            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-lg max-w-none text-on-surface">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold mb-6 text-on-surface">9. International Data Transfers</h2>
                            <p className="text-subtle mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold mb-6 text-on-surface">10. Third-Party Services</h2>
                            <p className="text-subtle mb-4">
                                Our platform may contain links to third-party websites and services. We are not responsible for the privacy practices of these external sites. We encourage you to review the privacy policies of any third-party services you use.
                            </p>
                        </section>

                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold mb-6 text-on-surface">11. Children's Privacy</h2>
                            <p className="text-subtle mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold mb-6 text-on-surface">12. Changes to This Privacy Policy</h2>
                            <p className="text-subtle mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-semibold mb-6 text-on-surface">13. Contact Information</h2>
                            <p className="text-subtle mb-4">
                                If you have any questions about this Privacy Policy or our privacy practices, please contact us:
                            </p>
                            <div className="bg-surface p-6 rounded-lg border border-muted">
                                <p className="text-subtle mb-2"><strong>Email:</strong> privacy@Clienn CRM.app</p>
                                <p className="text-subtle mb-2"><strong>Phone:</strong> +1 (555) 123-4567</p>
                                <p className="text-subtle mb-2"><strong>Address:</strong> 123 Innovation Drive, Suite 456, Tech City, 78910</p>
                                <p className="text-subtle mb-4"><strong>Data Protection Officer:</strong> privacy-officer@Clienn CRM.app</p>
            ...
            <footer className="bg-surface border-t border-muted mt-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center text-sm text-subtle">
                        <p>&copy; {new Date().getFullYear()} Clienn CRM. All rights reserved.</p>
                        <div className="flex justify-center gap-6 mt-4">
                            <Link to="/privacy" className="text-primary-600 hover:text-primary-700 transition-colors">
                                Privacy Policy
                            </Link>
                            <a href="#" className="text-subtle hover:text-on-surface transition-colors">
                                Terms of Service
                            </a>
                        </div>
                    </div>
