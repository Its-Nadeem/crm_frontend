...
export interface WebhookConfig {
    ...
    apiKey?: string;
    secret?: string;
    events: ('lead.created' | 'lead.updated' | 'lead.deleted' | 'lead.stage_changed' | 'lead.assigned' | 'lead.received')[];
...
export type PaymentGatewayProvider = 'stripe' | 'razorpay' | 'paypal' | 'payu' | 'paytm' | 'square' | 'braintree' | 'adyen' | 'authorize.net';

export interface PaymentGatewaySetting {
    provider: PaymentGatewayProvider;
    name: string;
    config: Record<string, string>; // Flexible config object for different providers
    isEnabled: boolean;
}
