...
class FacebookWebhookController {
    ...
    async processLeadGenEvent(webhookEvent) {
        ...
        try {
            ...
            const leadDetails = await this.facebookService.getLeadDetails(leadgenId, pageAccessToken);
            ...
            const normalizedLead = this.facebookService.normalizeLeadData(leadDetails, fieldMapping);
    ...
    try {
        ...
        const leads = await this.facebookService.fetchLeadsFromFacebook(formId, pageAccessToken, since, until);
        ...
        for (const leadData of leads) {
            try {
                ...
                // Normalize and save
                const normalizedLead = this.facebookService.normalizeLeadData(leadData, fieldMapping);
