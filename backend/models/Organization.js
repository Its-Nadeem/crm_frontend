...
// Indexes for efficient querying and constraints
organizationSchema.index({ id: 1, 'apiKeyStatus': 1 });

// Generate API key for organization
organizationSchema.methods.generateApiKey = function() {
  // Generate a more readable API key format: org_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
