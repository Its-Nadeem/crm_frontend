        ...
        const fetchData = async () => {
            try {
                ...
                const [templatesData, campaignsData] = await Promise.all([
                    fetch('/api/marketing/templates/email', { headers: authHeaders }).then(res => res.json()).then(res => res.data || []).catch(() => []),
                    fetch('/api/marketing/campaigns/email', { headers: authHeaders }).then(res => res.json()).then(res => res.data || []).catch(() => [])
                ]);
