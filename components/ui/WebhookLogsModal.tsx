...
const WebhookLogsModal: React.FC<WebhookLogsModalProps> = ({
    ...
    const fetchLogs = async () => {
        try {
            ...
            const url = `https://crm.clienn.com/api/webhooks/${webhookId}/logs?${queryParams}`;
    ...
    const retryDelivery = async (deliveryId: string) => {
        try {
            ...
            const response = await fetch(`https://crm.clienn.com/api/webhooks/deliveries/${deliveryId}/retry`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
