                ...
                if (condition.field && condition.value) {
                    if (condition.field === 'createdAt') {
                        if (condition.value === 'custom') {
                            // For custom, startDate and endDate are already handled below
                        } else {
                            // For date ranges, calculate start and end dates
                            const { startDate, endDate } = calculateDateRange(condition.value);
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            newConditions[index] = {
                                                ...
                                                condition: e.target.value === 'createdAt' ? 'equals' : 'contains',
                                                value: e.target.value === 'createdAt' ? 'last_7_days' : ''
                                            };
                                            ...
                                            {condition.value === 'custom' && (
                                                <div className="mt-2 space-y-2">
                                                    <div className="relative">
                                                        <label htmlFor={`startDate-${index}`} className="block text-xs font-medium text-on-surface mb-1">
                                                            Start Date
                                                        </label>
                                                        <div className="relative">
                                                            <input
                                                                ...
                                                                className="w-full px-3 py-2 pr-10 border border-muted rounded-lg bg-background text-on-surface text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                                                            />
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                                                    const input = document.getElementById(`startDate-${index}`) as HTMLInputElement;
                                                                    if (input) {
                                                                        input.showPicker ? input.showPicker() : input.focus();
                                                                    }
                                                                }}
                                                                className="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer hover:text-primary-600 transition-colors"
                                                                title="Open calendar"
                                                            >
                                                                <svg className="h-4 w-4 text-subtle hover:text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div className="relative">
                                                        <label htmlFor={`endDate-${index}`} className="block text-xs font-medium text-on-surface mb-1">
                                                            End Date
                                                        </label>
                                                        <div className="relative">
                                                            <input
                                                            ...
                                                            <button
                                                                type="button"
                                                                onClick={() => {
                                                                    const input = document.getElementById(`endDate-${index}`) as HTMLInputElement;
                                                                    if (input) {
                                                                        input.showPicker ? input.showPicker() : input.focus();
                                                                    }
                                                                }}
