...
export const HOMEPAGE_CONTENT: HomepageContent = {
  ...
  footer: {
    ...
    columns: [
        ...
        { title: 'Resources', links: [{ text: 'Help Center', url: '#' }, { text: 'API Docs', url: '//crm.clienn.com/api-docs' }, { text: 'Case Studies', url: '#' }, { text: 'Webinars', url: '#' }] },
    ],
    socialLinks: [
    ...
    legal: {
        ...
        links: [{ text: 'Privacy Policy', url: '/privacy' }, { text: 'Terms of Service', url: '#' }]
    }
  },
  finalCta: {
