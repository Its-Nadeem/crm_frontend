...
import {
    ...
    createOrUpdateLeadScoreRule, deleteLeadScoreRule, getLeadScoreRules,
...
import {
    getChatbotSettings, createOrUpdateChatbotSettings, updateChatbotSettings, deleteChatbotSettings, testChatbot
...
// Chatbot Settings
router.route('/chatbot').get(protect, getChatbotSettings).post(protect, createOrUpdateChatbotSettings).put(protect, updateChatbotSettings).delete(protect, deleteChatbotSettings);
router.route('/chatbot/test').post(protect, testChatbot);
